...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-16">
    ...
    {{-- ESTADO VACÍO: siempre en el DOM, oculto con 'hidden' si hay items, para que JS pueda mostrarlo sin recargar al eliminar el último producto --}}
    <div id="wishlistEmptyState"
    ...
    @if(count($items) > 0)
        {{-- GRID DE PRODUCTOS --}}
        <div id="wishlistGrid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-all duration-300 flex flex-col h-full">
                    ...
                    <div class="relative overflow-hidden bg-gray-50">
                        ...
                        <form method="POST" action="{{ route('wishlist.toggle') }}"
                            ...
                            onsubmit="eliminarDeWishlist(event, this)">
                            @csrf
                    ...
                    <div class="p-3 flex flex-col flex-1">
                        ...
                        <div class="mt-4 flex gap-2">
                            ...
                            @if($item->stock_total > 0)
                                ...
                                @else
                                    {{-- Agregar directo. La ubicación se toma de session('ubicacion_seleccionada')--}}
                                    <form method="POST"
