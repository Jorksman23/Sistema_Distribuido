            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('profile.show') }}"
                       class="flex items-center gap-2 bg-[#0300a3] hover:bg-[#0200cc] text-white text-sm font-semibold px-6 py-3 rounded-full transition">
                    ...
                    <a href="{{ route('catalogo.index') }}"
                       class="flex items-center gap-2 border border-[#0300a3] text-[#0300a3] hover:bg-blue-50 text-sm font-semibold px-6 py-3 rounded-full transition">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
