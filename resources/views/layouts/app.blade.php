...
// Buscador móvil — mismo comportamiento que el de escritorio
document.getElementById('search-mobile')?.addEventListener('keypress', function(e) {
